...
// console.log(`MY name is ${name} and my surname is ${lastname}`)  // Second way to add string/Modern way  it is known as string interpolation/template litrals/template string
